...
for ($private:i = 0; $private:i -lt 10; $private:i += 1) {
    ...
    $private:result=java -cp F:\java\screenShotAnalyzer\out\production\screenShotAnalyzer\ org.firas.tool.ssa.Main  match  D:\adb\adb_cap.png  D:\adb\MeituanFruit\CloseQuChouJiang.png 846 765 907 823 | findstr Matched
    echo $private:result
